...
//   // 🔽 Pull designations list from Redux
//   const designations = useSelector(
//     (state: RootState) => state.employeeDesignations.items
//   );

//   // 🔽 Try to resolve designation (id, code, or name depending on API)
...
const ProfessionalInfo: React.FC<ProfessionalInfoProps> = ({
  ...
  // You can add this log to check what's actually in your Redux state
