...
//         }
//         // HIGHLIGHT: Add this 'else if' condition
//         else if (value && parseFloat(value) > 200000) {
//           errorMessage = "Amount cannot exceed 200,000.";
//         }
//         break;
//       case "note":
//       case "staffNote":
...
interface AddLoanModalProps {
  ...
  onSubmit: (data: LoanFormData) => void;
  initialState: LoanFormData;
  loading: boolean; // Assuming a loading prop might be passed for the submit button
}
...
export default function AddLoanModal({
  ...
  // The form is valid if all required fields are filled AND there are no error messages.
  const isFormValid =
    formData.empName.trim() !== "" &&
    formData.amountReq.trim() !== "" &&
    formData.note.trim() !== "" &&
