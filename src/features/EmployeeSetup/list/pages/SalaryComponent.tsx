...
const SalaryComponent: React.FC<SalaryComponentProps> = ({
  ...
  useEffect(() => {
    const fetchSalaryData = async () => {
      ...
      setError(null);
      try {
        // This is a mock API call, replace with your actual fetch logic
        const mockData: InitialSalaryData = {
          employeeCode,
          employeeName,
          selectedMonth,
        ...
        // New: Add an error toast for fetch failure
  ...
  const calculatePayslip = useCallback(() => {
    ...
    // New: Add a success toast after calculation
  ...
  // Modified: handleCreatePayslip now uses async toasts
  const handleCreatePayslip = async () => {
