...
const FilterSidebar: React.FC<FilterSidebarProps> = ({
  ...
  // Modified: handleClear now includes a toast notification
  const handleClear = () => {
    onClear();
    setActiveFilter(null);
    toast("All filters have been cleared.", {
      icon: "ℹ️", // Optional: Add an info icon for better UI
      className: "bg-blue-50 text-blue-800",
    });
    onClose();
  };

  // Modified: handleApply now includes validation and a success toast
  const handleApply = () => {
    // New: Add validation for the date range
    if (
      ...
      return; // Prevent applying invalid filters
    }
