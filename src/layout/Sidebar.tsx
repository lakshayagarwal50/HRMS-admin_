...
//     icon: FileText,
//     subItems: [
//       { label: "Standard Reports", link: "/reports/standard" },
...
// Main menu items (Logout is now handled separately)
...
// MODIFIED SECTION: Updated the 'reportsMenuItems' array to match your screenshots
