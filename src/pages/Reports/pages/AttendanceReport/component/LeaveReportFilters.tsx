...
const LeaveReportFilters: React.FC<LeaveReportFiltersProps> = ({
  ...
  const handleDownloadClick = (format: "csv" | "excel") => {
    onDownload(format);
  };
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex justify-end items-center space-x-2 p-4 border-b">
            <button
              onClick={handleRunClick}
              disabled={isLoading}
              className="flex items-center space-x-2 bg-[#741CDD] text-white font-semibold py-2 px-4 rounded-lg hover:opacity-90 transition-colors disabled:opacity-50"
            >
              <Play size={16} />
              <span>Run</span>
            </button>
            <button
              ...
              disabled={isLoading}
              className="flex items-center space-x-2 bg-purple-100 text-[#741CDD] font-semibold py-2 px-4 rounded-lg hover:bg-purple-200 transition-colors disabled:opacity-50"
            >
              <Download size={16} />
          ...
          <div className="p-6 overflow-y-auto flex-grow">
            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
              ...
              >
                <option value="">Choose</option>
                {/* Dynamically populate with employee names from an API if available */}
              </select>
