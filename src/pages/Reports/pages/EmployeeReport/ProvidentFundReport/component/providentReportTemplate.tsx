...
interface ProvidentReportTemplateProps {
  onBack: () => void;
}

const providentReportTemplate: React.FC<ProvidentReportTemplateProps> = ({
  onBack,
}) => {
    ...
    <div className="p-8 bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">
          Provident Fund Summary Report Template
        </h1>
...
export default providentReportTemplate;
